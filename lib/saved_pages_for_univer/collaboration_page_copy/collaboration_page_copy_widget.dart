...
import 'collaboration_page_copy_model.dart';
export 'collaboration_page_copy_model.dart';

class CollaborationPageCopyWidget extends StatefulWidget {
  const CollaborationPageCopyWidget({super.key});

  @override
  State<CollaborationPageCopyWidget> createState() =>
      _CollaborationPageCopyWidgetState();
}

class _CollaborationPageCopyWidgetState
    extends State<CollaborationPageCopyWidget> {
  late CollaborationPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollaborationPageCopyModel());
